...
"""
Django settings for bcis_web project.
...
WSGI_APPLICATION = 'bcis_web.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'bcis_web', 'static'),
)
SITE_ID = 1
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'bcis_web', 'templates'),],
        'OPTIONS': {
            'context_processors': [
